...
import { ArrowRight, Award, Mail, MessageSquare, Phone, FireExtinguisher } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16 items-center">
            ...
            <div className="relative reveal">
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-dark-light p-4 rounded-lg shadow-lg border border-dark-medium">
                <p className="font-semibold text-accent">Fondée en 2022</p>
          ...
          {/* Mission & Values */}
          <div className="bg-dark-light rounded-lg p-8 mb-16 reveal border-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Mission */}
              <div className="bg-dark-medium p-6 rounded-lg shadow-md border-0">
              ...
              <div className="bg-dark-medium p-6 rounded-lg shadow-md border-0">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <Award className="text-accent h-5 w-5 mr-2" />
          ...
          <div className="mb-16 reveal">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {teamMembers.map((member, index) => (
                <div 
                  key={index}
                  className="bg-dark-light rounded-lg shadow-md overflow-hidden border-0"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16 items-center">
            ...
            <div className="order-1 md:order-2 reveal">
              ...
              <div className="space-y-4">
                <div className="bg-dark-light p-4 rounded-lg border-0">
                  <h3 className="font-bold mb-2">Sécurité Incendie</h3>
                  <p className="text-gray-300">Experts en prévention des risques incendie et en conformité avec la réglementation des ERP.</p>
                </div>
                <div className="bg-dark-light p-4 rounded-lg border-0">
                  <h3 className="font-bold mb-2">Intelligence Artificielle</h3>
                  <p className="text-gray-300">Algorithmes avancés pour l'analyse de plans et l'optimisation du positionnement des équipements de sécurité.</p>
                </div>
                <div className="bg-dark-light p-4 rounded-lg border-0">
                  <h3 className="font-bold mb-2">Réglementation</h3>
                  <p className="text-gray-300">Veille constante sur les évolutions réglementaires pour garantir des documents toujours conformes.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-16 reveal">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[1, 2, 3, 4].map((partner) => (
                <div key={partner} className="bg-dark-light p-6 rounded-lg shadow-md flex items-center justify-center h-32 border-0">
          ...
          {/* Contact CTA */}
          <div className="bg-dark-light rounded-lg overflow-hidden reveal border-0">
              ...
              <div className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <a href="tel:+33123456789" className="hover:underline text-gray-300">+33 1 23 45 67 89</a>
                  </div>
                  <div className="flex items-center">
                    <Mail className="h-5 w-5 mr-3 text-accent" />
                    <a href="mailto:contact@secugenie.com" className="hover:underline text-gray-300">contact@secugenie.com</a>
                  </div>
                  <div className="flex items-center">
                    <MessageSquare className="h-5 w-5 mr-3 text-accent" />
                    <span className="text-gray-300">Chat disponible du lundi au vendredi, 9h-18h</span>
                  </div>
                </div>
              </div>
              <div className="bg-dark-medium p-8 border-0">
                ...
                <div className="space-y-3">
                  <Link
                    to="/demo"
                    className="block w-full bg-accent hover:bg-accent-hover text-white py-2 px-4 rounded-md text-center font-medium transition-colors"
                  >
                    Essayer la démo
                  </Link>
                  <Link
                    to="/contact"
                    className="block w-full bg-dark-light hover:bg-dark-light/80 text-white py-2 px-4 rounded-md text-center font-medium transition-colors border border-accent/30"
                  >
                    Nous contacter
                  </Link>
                </div>
